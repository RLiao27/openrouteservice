package org.heigit.ors.api.requests.customize;
...
import org.heigit.ors.api.requests.centrality.CentralityRequestEnums;
...
public class CustomizeRequest extends APIRequest {
    public static final String PARAM_BBOX = "bbox";
    public static final String PARAM_TRAVELTYPE = "travelType";

    public static final String PARAM_ISCHOICETOLLWAYS = "isChoiceTollWays";
    ...
    @JsonProperty(PARAM_TRAVELTYPE)
    private String travelType;

    @JsonProperty(PARAM_ISCHOICETOLLWAYS)
    private Boolean isChoiceTollWays;
    ...
    @JsonCreator
    public CustomizeRequest(@JsonProperty(value = PARAM_BBOX, required = true) List<List<Double>> bbox) {
        this.bbox = bbox;
    }
    ...
    public List<Integer> getExcludeNodes() {
        return excludeNodes;
    }
    ...
    public Boolean getChoiceTollWays() {
        return isChoiceTollWays;
    }

    public void setChoiceTollWays(Boolean choiceTollWays) {
        isChoiceTollWays = choiceTollWays;
    }

    public boolean hasExcludeNodes() {
        return hasExcludeNodes;
    }
    ...
    public CentralityRequestEnums.Mode getMode() {
        return mode;
    }
    ...
    private org.heigit.ors.centrality.CentralityRequest convertCentralityRequest() throws StatusCodeException {
        ...
        try {
            ...
            throw new ParameterValueException(CentralityErrorCodes.INVALID_PARAMETER_VALUE, CustomizeRequest.PARAM_PROFILE);
        }
    ...
    BBox convertBBox(List<List<Double>> coordinates) throws ParameterValueException {
        if (coordinates.size() != 2) {
            throw new ParameterValueException(CentralityErrorCodes.INVALID_PARAMETER_VALUE, CustomizeRequest.PARAM_BBOX);
        }
